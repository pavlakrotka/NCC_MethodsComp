...
This repository contains the main code to reproduce the results of the paper "[Treatment-control comparisons in platform trials including non-concurrent controls](https://arxiv.org)".
