...
```{r, fig.width = 9, fig.height = 7}
p <- ggarrange(ggplot(results_i_eq_alpha_TM_step %>% filter(model=="Time machine"), 
                 ...
                 scale_x_continuous(breaks = seq(min(results_i_eq_alpha_TM_step$lambda0), max(results_i_eq_alpha_TM_step$lambda0), by=0.05),
                                    labels = round(seq(min(results_i_eq_alpha_TM_step$lambda0), max(results_i_eq_alpha_TM_step$lambda0), by=0.05), 3)) +
                 theme_bw(base_size = 13.4) +
                 theme(legend.position = c(0.28, 0.83),
                       legend.background = element_blank()),
               
               ggplot(results_i_eq_alpha_MAP %>% filter(model=="MAP Prior"), 
                 ...
                 coord_cartesian(ylim = c(0, 0.1)) +
                 scale_color_manual(values = my_palette) +
                 scale_x_continuous(breaks = seq(min(results_i_eq_alpha_MAP$lambda0), max(results_i_eq_alpha_MAP$lambda0), by=0.05),
                                    labels = round(seq(min(results_i_eq_alpha_MAP$lambda0), max(results_i_eq_alpha_MAP$lambda0), by=0.05), 3)) +
                 theme_bw(base_size = 13.4) +
